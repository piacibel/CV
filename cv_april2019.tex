...
\address{11 Rue Marx-Dormoy}{94230 Cachan}
...
\cventry{Février 2013 \\ Septembre 2013}
{Stagiaire}{INRIA}{Bordeaux}{Développement d'un noyau d'approximation
  de champ lointain basé les séries de Taylor pour une méthode de
  FMM}{Environnement technique : C, C++, Linux, git}
...
\cventry{IAP-CNRS}{Ingénieur d'étude}{Participation au développement du
  ...
  \end{enumerate}
  Environnement technique: Python, Git\\
  % \smallskip
}
